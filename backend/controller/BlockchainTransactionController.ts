...
// repositories
import BlockchainEventLocalRepository from "../src/repositories/local/BlockchainEventLocalRepository";
const blockchainEventRepository = BlockchainEventLocalRepository.getInstance();

// usecases
import GetAuctionItems from "../src/core/services/GetAuctionItems"
import GetBidders from "../src/core/services/GetBidders"
import GetSignatures from "../src/core/services/GetSignatures"
